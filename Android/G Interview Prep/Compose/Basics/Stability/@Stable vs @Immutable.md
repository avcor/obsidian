...
## Immutability 
- This is a strict promise. It guarantee that nothing inside the object will ever change after it is created. If any part needs to change then completely new instance needs to be created and passed. 
